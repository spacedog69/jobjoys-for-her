  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_dropdowns: "flex justify-center items-center gap-2 py-2",
        dropdown: "p-2 bg-white border rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary",
